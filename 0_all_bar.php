...
{
	$query = mysqli_query($koneksi,"SELECT sum(totaldeaths) AS jumlah FROM tb_covid19 WHERE '$bulan'");
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(totalrecovered) AS jumlah FROM tb_covid19 WHERE '$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(totalcases) AS jumlah FROM tb_covid19 WHERE '$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(activecases) AS jumlah FROM tb_covid19 WHERE '$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(totaltests) AS jumlah FROM tb_covid19 WHERE '$bulan'");
	$row = $query->fetch_array();
